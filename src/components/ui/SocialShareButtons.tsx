...
export function SocialShareButtons({ url, text, source }: SocialShareButtonsProps) {
  ...
  const buttonClass =
    "inline-flex items-center justify-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-bold border-2 border-foreground bg-background text-foreground hover:bg-foreground hover:text-background active:translate-y-0.5 transition-all duration-100";
