...
export const metadata = {
  title: "Privacy Policy | ActionBoost",
  description: "How ActionBoost collects, uses, and protects your data.",
}
            ...
            <div className="prose prose-neutral max-w-none text-foreground/90 space-y-6 font-serif">
              <section>
                ...
                <p className="text-sm text-muted leading-relaxed">
                  ActionBoost is operated from Texas, United States. For privacy inquiries, contact
                  us at{" "}
                  <a
              ...
              <section>
                ...
                <p className="text-sm leading-relaxed text-muted mb-3">
                  When you use ActionBoost, we collect:
                </p>
              ...
              <section>
                ...
                <p className="text-sm text-muted mb-3">
                  We share data with these services to provide ActionBoost:
                </p>
                <ul className="text-sm text-muted space-y-2 list-disc list-inside">
                  <li>
