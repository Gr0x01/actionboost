  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <article className="mx-auto max-w-3xl px-4 md:px-8 py-12 md:py-20">
          {/* Hero */}
          ...
          <div className="prose-boost">
            ...
            <h2>What a Marketing Plan Should Actually Include</h2>
            ...
            <p>
              "Get more customers" isn't a goal. "Acquire 50 trial signups in 30
              days from organic search" is.
            </p>
            ...
            <p>
              Demographics are useless. "Marketing managers aged 25-45" tells
            ...
            <p>Pick 1-2 channels to start. Not seven. Not "omnichannel."</p>
            ...
            <p>
              Define what "working" looks like before you start. Otherwise
            ...
            <h2>Why Most Marketing Plans Fail</h2>
            ...
            <p>
              "Just post on LinkedIn" or "start a newsletter" isn't advice. It's
            ...
            <h2>How to Research Your Competitors (The Hard Part)</h2>
            ...
            <p>
              For most businesses, the biggest competitor is "do nothing." Your
            ...
            <p>
              ...
              they get 30K from organic search on "email productivity tips" and
            ...
            <h2>The Stop/Start/Continue Framework</h2>
            ...
            <ul>
              ...
              <li>"Brand building" activities with no measurable outcome</li>
            </ul>
            ...
            <ul>
              <li>
                "Start creating content for [keyword cluster] where Competitor X
                is weak"
              </li>
              <li>
                "Start building presence on [platform] where our audience is
                active but competitors aren't"
              </li>
              <li>
                "Start outbound to [specific segment] that competitors are
                ignoring"
              </li>
            </ul>
            ...
            <h2>Building Your 30-Day Marketing Roadmap</h2>
            ...
            <h2>Real Examples by Industry</h2>
          ...
          {/* CTA Section */}
          <div className="mt-12 rounded-lg border-2 border-foreground/20 bg-white p-8 shadow-[4px_4px_0_rgba(44,62,80,0.1)]">
            ...
            <p className="text-foreground/70 mb-6">
              <strong className="text-foreground">{config.singlePrice}. One-time. No subscription.</strong>
              <br />
              Fill out a 5-minute questionnaire. Get a complete marketing plan
              in about 5 minutes.
            </p>
